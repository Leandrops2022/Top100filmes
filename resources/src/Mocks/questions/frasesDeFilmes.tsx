...
export const tituloESubtitulo = {
  "titulo": "Voce sabe dizer de quais filmes são essas frases icônicas?",
  "subtitulo": "tente lembrar em quais filmes ouviu!"
};

const frasesDeFilmes: Question[] = [
  {
    "question": "Que a força esteja com você.",
    "answers": [
      {
...
export {frasesDeFilmes, personality, results, imagens};