    ...
    <x-authentication-card>
        ...
        <div x-data="{ recovery: false }">
            <div class="mb-4 text-sm text-gray-600 dark:text-gray-400" x-show="! recovery">
                ...
                {{ __('Por favor, confirme o acesso à sua conta informando o código fornecido pelo seu aplicativo autenticador.') }}
            </div>

            <div class="mb-4 text-sm text-gray-600 dark:text-gray-400" x-cloak x-show="recovery">
                {{ __('Por favor, confirme o acesso à sua conta informando um dos códigos de recuperação de conta.') }}
            </div>
