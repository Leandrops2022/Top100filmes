@props(['title' => __('Confirmação de senha'), 'content' => __('Para sua Segurança, por favor confirme sua senha para continuar.'), 'button' => __('Confirmar')])
    ...
    <x-dialog-modal wire:model="confirmingPassword">
        ...
        <x-slot name="content">
            ...
            <div class="mt-4" x-data="{}"
                ...
                <x-input type="password" class="mt-1 block w-3/4" placeholder="{{ __('Senha') }}"
