...
return [
    ...
    | dados pelo provedor de senha quando a tentativa de atualização de senha falha,
    | tal como um token inválido ou nova senha inválida.
    |
    */

    'reset' => 'Sua senha foi redefinida.',
    'sent' => 'Nós enviamos um link de redefinição de senha para o seu e-mail.',
